...
pub struct MarkerTemplate {
    ...
    pub mount: Option<Mounts>,
    pub profession: Option<Professions>,
    pub race: Option<Races>,
    ...
    pub specialization: Option<Specializations>,
    pub texture: Option<String>,
    pub tip_name: Option<u16>,
    pub tip_description: Option<u16>,
...
//             icon_file: None,
//             icon_size: None,
//             in_game_visibility: None,
//             info: None,
//             info_range: None,
//             keep_on_map_edge: None,
//             map_display_size: None,
//             map_fade_out_scale_level: None,
//             map_visibility: None,
//             map_type: None,
//             max_size: None,
//             min_size: None,
//             mini_map_visibility: None,
//             mount: None,
//             profession: None,
//             race: None,
//             reset_length: None,
//             reset_offset: None,
//             scale_on_map_with_zoom: None,
//             specialization: None,
//             texture: None,
//             tip_name: None,
//             tip_description: None,
//             toggle_cateogry: None,
//             trail_data_file: None,
//             trail_scale: None,
//             trigger_range: None,
//         }
//     }
...
impl MarkerTemplate {
    ...
    pub fn inherit_from_template(&mut self, other: &MarkerTemplate) {
        ...
        if self.anim_speed.is_none() {
            self.anim_speed = other.anim_speed;
        }
        ...
        if self.copy_message.is_none() {
            self.copy_message = other.copy_message;
        }
        ...
        if self.festival.is_none() {
            self.festival = other.festival;
        }
