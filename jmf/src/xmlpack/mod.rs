...
impl MarkerTemplate {
    ...
    pub fn inherit_from_template(&mut self, other: &MarkerTemplate) {
        ...
        if self.copy.is_none() {
            self.copy = other.copy.clone();
        }
        if self.copy_message.is_none() {
            self.copy_message = other.copy_message.clone();
        }
        ...
        if self.festival.is_none() {
            self.festival = other.festival.clone();
        }
        ...
        if self.map_scale.is_none() {
            self.map_scale = other.map_scale;
        }
