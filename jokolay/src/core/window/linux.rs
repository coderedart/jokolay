...
//                     .map_err(|e| {
//                         tracing::error!("couldn't connect to xserver. error: {:#?}", &e);
//                         e
//                     })
//                     .unwrap();
//                 xc = conn;
...
//                     .try_into()
//                     .map_err(|e| {
//                         tracing::error!("could not fit ow_window_handle into u32");
//                         e
//                     })
//                     .unwrap();
...
//                     .map_err(|e| {
//                         tracing::error!("could not get gw2 xid. error: {:?}", &e);
//                         e
//                     })
//                     .unwrap()
//                     .try_into()
//                     .map_err(|e| {
//                         tracing::error!("could not fit gw_window_handle into u32");
//                         e
//                     })
//                     .unwrap();
...
//             .map_err(|e| {
//                 tracing::error!("coudn't intern WM_TRANSIENT_FOR due to error: {:#?}", &e);
//                 e
//             })
//             .unwrap()
//             .reply()
...
//         .check()
//         .map_err(|e| {
//             tracing::error!("reply for changing transient_for has error: {:#?}", &e);
//             e
//         })
//         .unwrap();
//     }
...
//             .map_err(|e| {
//                 tracing::error!("coudn't get geometry of gw2 due to error: {:#?}", &e);
//                 e
//             })
//             .unwrap()
//             .reply()
//             .map_err(|e| {
//                 tracing::error!("reply for getting geometry has error: {:#?}", &e);
//                 e
//             })
//             .unwrap();
...
//         .reply()
//         .map_err(|e| {
//             tracing::error!("reply for getting translation coords has error: {:#?}", &e);
//             e
//         })
//         .unwrap();
...
//         )
//         .map_err(|e| {
//             tracing::error!("coudn't get frame property gw2 due to error: {:#?}", &e);
//             e
//         })
//         .unwrap()
//         .reply()
//         .map_err(|e| {
//             tracing::error!("reply for frame property gw2 has error: {:#?}", &e);
//             e
//         })
//         .unwrap();
...
//             tracing::error!("frame_prop format is {}", frame_prop.format);
//             panic!()
//         }
//         if frame_prop.value_len != 4 {
//             tracing::error!("frame_prop value_len is {}", frame_prop.value_len);
//             panic!()
//         }
//         if frame_prop.value.len() != 16 {
//             tracing::error!("frame_prop.value.len() is {}", frame_prop.value.len());
//             panic!()
//         }
...
//             .reply()
//             .map_err(|e| {
//                 tracing::error!("reply for intern atom for _NET_WM_PID has error: {:#?}", &e);
//                 e
//             })
//             .unwrap();
...
//         .reply()
//         .map_err(|e| {
//             tracing::error!("reply for _NET_WM_PID property gw2 has error: {:#?}", &e);
//             e
//         })
//         .unwrap();
...
//             tracing::error!("_NET_WM_PID format is {}", pid_prop.format);
//             panic!()
//         }
//         if pid_prop.value_len != 1 {
//             tracing::error!("_NET_WM_PID value_len is {}", pid_prop.value_len);
//             panic!()
//         }
//         if pid_prop.value.len() != 4 {
//             tracing::error!("_NET_WM_PID.value.len() is {}", pid_prop.value.len());
//             panic!()
//         }
