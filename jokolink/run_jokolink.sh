...
export dest_file_path='z:\\dev\\shm\\MumbleLink'
# 
# this command will use $WINE from lutris and use the above options to run jokolink in bg
$WINE './jokolink.exe' -l $jl_log_level -m $link_name -d $jl_logfile_dir -i $mumble_interval -g $gw2_check_alive -f $dest_file_path &>  jokolink_cmd_output.txt
