...
use crate::{glc::gltypes::texture::Texture, window::OverlayWindow};
...
pub struct EguiInterface {
    ...
    pub overlay_window: Rc<RefCell<dyn OverlayWindow>>,
}
...
impl EguiInterface {
    ...
    pub fn new(gl: Rc<Context>, overlay_window: Rc<RefCell<dyn OverlayWindow>>) -> Self {
