...
use crate::core::{painter::opengl::texture::TextureServer, TextureCommand};
...
pub struct TextureClient {
    ...
    pub tex_commands: Option<Vec<TextureCommand>>,
...
impl TextureClient {
    ...
    fn allocate_upload_pixels(
        ...
        if let Some(ref mut tm) = self.tex_commands {
            tm.push(TextureCommand::BumpTextureArraySize);
        }
